<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="HOPrintApplicationReport.aspx.cs" Inherits="mis_HRMS_HOPrintApplicationReport" %>
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="=page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><span>Compassionate Appointment Print Application HO</span></li>
                    </ol>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-5" style="position: relative; bottom: 15px;">
                            ...
                            <table class="table table-bordered text-center ">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Mobile No.<br />
                                            मोबाइल नंबर</th>
                                        <th>Applicant's Relationship with
                                <br />
                                            Deceased Teacher<br />

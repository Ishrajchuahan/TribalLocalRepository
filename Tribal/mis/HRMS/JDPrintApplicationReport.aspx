<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="JDPrintApplicationReport.aspx.cs" Inherits="mis_HRMS_JDPrintApplicationReport_aspxt" %>
        ...
        <div class="card-body">
                            ...
                            <table class="table table-bordered text-center ">
                                <thead>
                                    <tr>
                                        ...
                                        <th>पात्रता परीक्षा का वर्ष<br />
                                            Year of Eligibility Test</th>
            ...
            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl">
                    ...
                    <br />अनुकंपा नियुक्ति के लिए किये गये आवेदन की पावती</b></strong></h3>
                                    </div>
                                    <div class="col-sm-2">

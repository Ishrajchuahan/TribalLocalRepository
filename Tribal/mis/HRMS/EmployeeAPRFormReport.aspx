<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="EmployeeAPRFormReport.aspx.cs" Inherits="mis_HRMS_EmployeeAPRFormReport" %>
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="=page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><span>Employee APR Form Report</span></li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="card card-border-primary">
        <div class="card-header">
            <div class="row align-items-end">
                <div class="col-lg-12">
                    <h5 class="card-title">Employee APR Form Report/
                
कर्मचारी एपीआर फॉर्म रिपोर्ट
                    </h5>
                </div>
            </div>
        </div>
                            ...
                            <table id="Table1" class="table table-bordered text-center" runat="server">
                                ...
                                <tbody>
                                    <tr valign="middle">
                                        ...
                                        <td>2022-2023</td>
                                        <td>Rajesh Agrawal/AD4545</td>
                                        <td>
                                            <a href="../Document/pdfforAPR.pdf" class="btn btn-primary"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                    <tr valign="middle">
                                        <td>2</td>

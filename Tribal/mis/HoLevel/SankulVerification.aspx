<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="SankulVerification.aspx.cs" Inherits="mis_HoLevel_SankulVerification" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
                ...
                <div class="row align-items-end">
                    ...
                    <%--   <div class="col-md-2">
                        <div class="form-group">
                            <label >UDISE Code<span style="color: red;"> *</span></label>
                            <asp:DropDownList CssClass="form-control select2" runat="server">
                                ...
                                <asp:ListItem>2345030063</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>--%>
                    <%--<div class="col-md-6 col-lg-4 col-xl-3 mb-2">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="main-ul">
                                        ...
                                        <li><strong>UDISE Code / Sankul Name </strong>
                                            <ul>
                                                <li>UDISE Code / Sankul Name will be auto populated data based on selected <strong>Division, District and Block name </strong></li>
                                                <li>The UDISE Code / Sankul Name  for schools must be implemented as a <strong>Searchable</strong> dropdown.</li>
                                            </ul>
                                        </li>
 ...
 Additionally, by clicking on the 'Documents' Button, they can also view request, related documents .
                                        ...
                                        <li><strong>Create Sankul</strong>
                                            <ul>
                                                <li>It is mandatory to click on the checkbox in front of the data to <strong>Create</strong> the Sankul.
                                                  After that the Sankul will be Created</li>

        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">
                    <button type="button" class="btn w-lg btn-outline-success Alert-Close" data-bs-dismiss="modal">Submit</button>
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">Close School Verification</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <div class="row align-items-end">
                <div class="col-lg-12">
                    <h4 class="card-title">Close School Verification / स्कूल बंद करने का सत्यापन
                    </h4>
                </div>
            </div>
        </div>
        <div class="card-body">
            <fieldset>
                <legend>Close School Verification / स्कूल बंद करने का सत्यापन</legend>
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-12">
                        <div class="form-group ">
                            ...
                            <asp:Button ID="Button2" CssClass="btn w-lg btn-outline-danger btn-border" runat="server" Text="Clear" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <fieldset runat="server" id="report" visible="false">
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-3 col-md-6 mt-3">
                                                <label>
                                                    Date<br />
                                                    तारीख</label>
                                                <asp:TextBox ID="TextBox4" placeholder="15/11/2023" ReadOnly="true" runat="server" CssClass="datepicker form-control"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-3 col-md-6 mt-3">
                                                <label>
                                                    Order Document Type
                                                ...
                                                <asp:TextBox ID="TextBox10" placeholder="Order Letter" ReadOnly="true" runat="server" CssClass="form-control"></asp:TextBox>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-md-6 mt-3">
                                                <label>
                                                    Order No<br />
                                                    आदेश संख्या</label>
                                                <asp:TextBox ID="TextBox11" placeholder="1248745" ReadOnly="true" runat="server" CssClass=" form-control"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-3 col-md-6 mt-3">
                                                <label>
                                                    Effective Date<br />
                                                    प्रभावी तिथि</label>
                                                <asp:TextBox ID="TextBox12" placeholder="20/11/2023" ReadOnly="true" runat="server" CssClass="datepicker form-control"></asp:TextBox>
                                            </div>
                        ...
                        <div class="row" runat="server" id="divbtn" visible="false">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    <button type="button" class="btn w-lg btn-outline-success btn-rounded" data-bs-toggle="modal" data-bs-target="#OTPModal">Close School</button>

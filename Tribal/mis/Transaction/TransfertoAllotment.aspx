<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="TransfertoAllotment.aspx.cs" Inherits="mis_Transaction_TransfertoAllotment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" Runat="Server">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="=page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><span>Transfer to Allotment Report</span></li>
                    </ol>
                </div>
            </div>
        </div>
   ...
   <div class="card card-border-primary">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="card-title">Transfer to Allotment Report / आवंटन रिपोर्ट में स्थानांतरण</h4>
                </div>
            </div>
        </div>
        <div class="card-body">
            <fieldset>
                <legend>Transfer to Allotment Report / आवंटन रिपोर्ट में स्थानांतरण</legend>
                <div class="row">
                     <div class="col-md-3">

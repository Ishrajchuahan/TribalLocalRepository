<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="GenerateListHigherOfficeCharge.aspx.cs" Inherits="mis_Transaction_GenerateListHigherOfficeCharge" %>
    ...
    <div class="content-wrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <a class="btn btn-outline-danger btn-border w-lg" href="GenerateListHigherOfficeCharge.aspx">Clear</a>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                                    ...
                                    <table class="table text-center table-bordered">
                                        <tr class="card-header">
                                            ...
                                            <th>Action
                                                <br />
                                                कार्यवाही
                                                <input type="checkbox" id="upcheck" class="form-check" onchange="toggleDivVisibility()" />
       ...
       <br />
        ...
        <br />
                            ...
                            <span style="color:red; font-weight:bold">नोट - आर्डर जनरेट या सूची से डाटा हटाने हेतु चेकबॉक्स का उपयोग करें |</span>
                    ...
                    <div class="row" id="generateorder" style="display: none">
                        <div class="col-md-12 text-center">
                            ...
                            <button type="button" class="Alert-Delete btn btn-outline-danger btn-border w-lg">Delete</button>
                        </div>

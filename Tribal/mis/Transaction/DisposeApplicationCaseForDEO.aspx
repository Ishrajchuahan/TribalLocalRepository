<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="DisposeApplicationCaseForDEO.aspx.cs" Inherits="mis_Transaction_DisposeApplicationCase" %>
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="=page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><span>DEO Compassionate Application Approval</span></li>
                    </ol>
                </div>
            </div>
        </div>

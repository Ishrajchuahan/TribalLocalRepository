<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="TextBookViewDamagedBundles.aspx.cs" Inherits="mis_Scheme_TextBookViewDamagedBundles" %>
    ...
    <div class="row page-titles mb-4">
        ...
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="TextBookViewDamagedBundles.aspx" title="click to go on">View textbooks delivered to the consignee (Block Office)</a></li>
                </ol>
            </div>
        </div>
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    <legend>क्षतिग्रस्त के रूप में रिपोर्ट किए गए बंडल देखें</legend>
                    <div class="row justify-content-center">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-2 text-center">
                                <div class="form-group">
                                    <button type="button" id="btnShowStudentDetails" class="btn btn-success btn-rounded btn-block">Show</button>
                                </div>
                            </div>
                        </div>
                    </div>

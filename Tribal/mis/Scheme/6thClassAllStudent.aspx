<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="6thClassAllStudent.aspx.cs" Inherits="mis_Scheme_6thClassAllStudent" %>
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="=page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">All Students in 6th Class</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="card card-border-primary">
        <div class="card-header">
            <div class="row align-items-end">
                <div class="col-lg-9">
                    <h4 class="card-title">All Students in 6th Class /
                       छठी कक्षा के सभी छात्र</h4>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="mt-3">
                <fieldset>
                    <legend>All Students in 9th Class / छठी कक्षा के सभी छात्र  </legend>
                    <div class="row align-items-end">
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <a href="6thClassAllStudent.aspx" class="btn btn-outline-danger btn-border w-lg">Clear</a>
                            </div>
                        </div>
                    </div>
                </fieldset>
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table text-center table-bordered table-hover text-center">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>GHSS MODEL GHATIGAON (6-12)	</td>
                                                <td>23040303327</td>
                                                <td>Ghatigaon (Barai)	</td>
                                                <td>GHATIGAO (P)</td>
                                                <td>Janpad Panchayat, GHATIGAON</td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <table class="table text-center table-bordered table-hover text-center">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Basahat/Colony<br />बसाहट/बस्ती</th>
                                                <th>Eligible for Cycle<br />साइकिल के लिए पात्र</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>16/02/2009</td>
                                                <td>Boy</td>
                                                <td>Janpad Panchayat, BHITARWAR</td>
                                                <td>URVA(P)</td>
                                                <td>Urwa</td>
                                                <td>Adiwasi Urwa</td>
                                                <td>No</td>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="DistrictTextbookDistribution.aspx.cs" Inherits="mis_Scheme_DistrictTextbookDistribution" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    <div class="row page-titles mb-4">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor ">Information about distribution of free textbooks in the district</h4>
        </div>
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="DistrictTextbookDistribution.aspx" title="click to go on">Information about distribution of free textbooks in the district</a></li>
                </ol>
            </div>
        </div>

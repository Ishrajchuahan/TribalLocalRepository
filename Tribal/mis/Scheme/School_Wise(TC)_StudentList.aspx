<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="School_Wise(TC)_StudentList.aspx.cs" Inherits="mis_Scheme_RegisterRequestTC" %>
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mt-4">
                        <div class="form-group">
                            <a href="School_Wise(TC)_StudentList.aspx" class="btn btn-danger btn-rounded">Clear</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>8th</td>
                                    <td>23040315801</td>
                                    <td>CMRISE (Campus)- GGMS KULAITH (1 to 8)</td>

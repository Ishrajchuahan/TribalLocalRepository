<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true"  CodeFile="FreeTextbookDistributionJanShikshaKendrawise.aspx.cs" Inherits="mis_Scheme_FreeTextbookDistributionJanShikshaKendrawise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    <div class="row page-titles mb-4">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor ">Free Textbook - JanShiksha Kendrawise wise distribution information</h4>
        </div>
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="FreeTextbookDistributionJanShikshaKendrawise.aspx" title="click to go on">Free Textbook distribution- JanShikshaKendrawise wise</a></li>
                </ol>
            </div>
        </div>
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    <fieldset>
                        <legend>Free Textbook - JanShiksha Kendrawise wise distribution information </legend>
                                        ...
                                        <table class="table text-center table-bordered table-hover text-center">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>% Performanc by Schools of Jan Shiksha Kendra </th>                                                   
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>GWALIOR</td>
                                                    <td>DABRA</td>
                                                    <td>GHS MOHANGAD BHITARWAR (Class- 6 to 10)</td>
                                                    <td>Hindi</td>
                                                    <td>6th</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>GWALIOR</td>
                                                    <td>DABRA</td>
                                                    <td>GHSS KARHIYA BHITARWAR (Class- 1 to 12)</td>
                                                    <td>Hindi</td>
                                                    <td>6th</td>
                                                    <td>First Language - Hindi Special/Specialized other</td>
                                                    <td>Bhasha Bharati-7</td>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td>GWALIOR</td>
                                                    <td>DABRA</td>
                                                    <td>GHS KACHAUA BHITARWAR (Class- 6 to 10)</td>
                                                    <td>Hindi</td>
                                                    <td>7th</td>

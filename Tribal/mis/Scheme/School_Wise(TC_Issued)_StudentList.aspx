<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="School_Wise(TC_Issued)_StudentList.aspx.cs" Inherits="mis_Scheme_RegisterRequestTC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
        ...
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">School Wise TC Students List </li>
                </ol>
            </div>
        </div>
    </div>
    <div class="card mt-3 shadow">
        ...
        <div class="card-body">
            ...
            <fieldset>
                <legend>School Wise TC Students List</legend>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control">
                                <option value="value"><---Select---></option>
                                <option value="NGPS ADIWASI PURA" selected>NGPS ADIWASI PURA</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3 mt-4">
                        <div class="form-group">
                            <a href="School_Wise(TC_Issued)_StudentList.aspx" class="btn btn-danger btn-rounded">Clear</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tr>
                                    ...
                                    <th>जेंडर</th>
                                    <th>DOB</th>
                                    <th>कक्षा विद्यालय कोड</th>
                                    <th>विद्यालय</th>
                                    <th>दर्जकर्ता</th>
                                    <th>TC जारी करने की तिथि</th>
                                </tr>
                                <tr>
                                    <td>1</td>
                                    <td>185123619</td>
                                    ...
                                    <td>8th</td>
                                    <td>23040315801</td>
                                    <td>Umesh Sharma, Sahayak Adhyapak, GPS HUKUM GAR, Gwalior - District</td>
                                    <td>Apr 4 2024 8:30AM</td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>300231775</td>
                                    <td>Shailendra Baghel</td>
                                    <td>Gyan Singh</td>
                                    <td>Premvati Baghel</td>
                                    <td>M</td>
                                    <td>01/01/2014</td>
                                    <td>5th</td>
                                    <td>23040307701</td>
                                    <td>Umesh Sharma, Sahayak Adhyapak, GPS HUKUM GAR, Gwalior - District</td>
                                    <td>Apr 5 2024 8:30AM</td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>307898969</td>

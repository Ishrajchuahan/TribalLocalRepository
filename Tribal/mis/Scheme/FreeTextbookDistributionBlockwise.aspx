<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true"  CodeFile="FreeTextbookDistributionBlockwise.aspx.cs" Inherits="mis_Scheme_FreeTextbookDistributionBlockwise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    <div class="row page-titles mb-4">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor ">Free Textbook - Block wise distribution information</h4>
        </div>
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="FreeTextbookDistributionBlockwise.aspx" title="click to go on">Free Textbook distribution- Block wise</a></li>
                </ol>
            </div>
        </div>
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    <fieldset>
                        <legend>Free Textbook - Block wise distribution information </legend>
                                        ...
                                        <table class="table text-center table-bordered table-hover text-center">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>BRC Performance % achieved by School</th>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="6thClassCycleSelectionStudent.aspx.cs" Inherits="mis_Scheme_6thClassCycleSelectionStudent" %>
                                        ...
                                        <table class="table text-center table-bordered table-hover text-center">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td>104458164</td>
                                                    <td>VIKASH SAHARIYA</td>
                                                    <td>MAANSINGH SAHRIYAA</td>
                                                    <td>01/01/2009</td>
                                                    <td>Boy</td>
                                                    <td>9770013059</td>
                                                    <td>Janpad Panchayat, GHATIGAON</td>
                                                    <td>AARON (P)</td>
                                                    <td>manpatan aron ka pura</td>
                                                </tr>
                                            </tbody>
                                        </table>

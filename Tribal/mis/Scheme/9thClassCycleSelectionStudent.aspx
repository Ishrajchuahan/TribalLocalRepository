            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="=page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">9th Class Students Selected for Cycle Distribution</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="card card-border-primary">
        <div class="card-header">
            <div class="row align-items-end">
                <div class="col-lg-9">
                    <h4 class="card-title">9th Class Students Selected for Cycle Distribution
                        <br />
                        साइकिल वितरण के लिए 9वीं कक्षा के विद्यार्थियों का चयन</h4>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="mt-3">
                <fieldset>
                    <legend>9th Class Students Selected for Cycle Distribution / साइकिल वितरण के लिए 9वीं कक्षा के विद्यार्थियों का चयन</legend>
                    <div class="row align-items-end">
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <a href="9thClassCycleSelectionStudent.aspx" class="btn btn-outline-danger btn-border w-lg">Clear</a>
                            </div>
                        </div>
                    </div>
                </fieldset>

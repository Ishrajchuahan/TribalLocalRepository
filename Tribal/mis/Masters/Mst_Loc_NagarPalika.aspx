            ...
            <fieldset>
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <label>
                                Enter Nagar Palika Name (In English)<br />
                                नगर पालिका का नाम दर्ज करे(अंग्रेजी  में)<span style="color: red">*</span></label>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <label>
                                Enter Nagar Palika Name (In Hindi)<br />
                                नगर पालिका का नाम दर्ज करे(हिंदी में)<span style="color: red">*</span></label>
                            ...
                            <table class="table table-bordered text-center">
                                <thead class="nowrap">
                                    <tr>
                                        ...
                                        <br />
                                            विकासखण्ड का नाम</th>
                                        <th>Nagar Palika Name (In English)<br />
                                            नगर पालिका का नाम(अंग्रेज़ी में)</th>
                                        <th>Nagar Palika Name (In Hindi)<br />
                                            नगर पालिका का नाम(हिंदी में)</th>
                                        <th>Nagar Palika Code No.
                                        <br />

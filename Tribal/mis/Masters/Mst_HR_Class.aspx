<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Mst_HR_Class.aspx.cs" Inherits="mis_HR_Mst_Class" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="=page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">Class Master Data</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="marqueecontainer">
        ...
        <div>
            <marquee style="width: 100%;" onmouseover="this.stop();" onmouseout="this.start();" direction="left" behavior="scroll" scrollamount="7" class="Marqueetext">
                इस पेज के माध्यम से कर्मचारियों की श्रेणी का रजिस्ट्रेशन किया जाता है, यदि किसी कारणवश त्रुटी हो जाती हैं तो Registration Edit or Isactive भी किया जा सकता है|
            </marquee>
        </div>
    </div>
    <div class="card card-border-primary">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="card-title">Class Master / कक्षा मास्टर</h4>
                </div>
            </div>
        </div>
        <div class="card-body">
            <fieldset>
                <legend>Add Class / कक्षा जोड़े</legend>
                <div class="row align-items-end">
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <label>
                                Enter Class Name (In English)<br />
                                श्रेणी का नाम दर्ज करे(अंग्रेज़ी में)<span style="color: red">*</span></label>
                            <input name="ctl00$ContentBody$ctl00" type="text" class="form-control" autocomplete="off" placeholder="Enter Class Name" />
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <label>
                                Enter Class Name (In Hindi)<br />
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <label>
                                ...
                                कक्षा कोड संख्या दर्ज करे<span style="color: red">*</span></label>
            ...
            <fieldset>
                <legend>Class Details / कक्षा विवरण</legend>
                            ...
                            <table class="table table-bordered text-center">
                                <thead class="nowrap">
                                    <tr>
                                        ...
                                        <br />
                                            सरल क्र.</th>
                                        <th>Class Name(In English)<br />
                                            श्रेणी का नाम(अंग्रेज़ी में)</th>
                                        <th>Class Name(In Hindi)<br />
                                            श्रेणी का  नाम(हिंदी में)<br />
                                        </th>
                                        <th>Class Code No.
                                        <br />
                                            कक्षा कोड संख्या</th>

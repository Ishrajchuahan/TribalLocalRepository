<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="AdministrativeTransferPrintOrder.aspx.cs" Inherits="mis_Masters_AdministrativeTransferPrintOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    <div class="row page-titles mb-4">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor ">Generate Transfer Order/
               स्थानांतरण आदेश</h4>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <th>Privious DDO/Shankul</th>
                                    <th>Final Order Print Or Approve</th>
                                </tr>
                                <tr>
                                    <td>1</td>
                                    <td>12586</td>

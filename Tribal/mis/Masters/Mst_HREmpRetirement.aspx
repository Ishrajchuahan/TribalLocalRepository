         ...
         <br />
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3 mt-3">
                                    <div class="form-group">
                                        ...
                                        <br />
                                            विभाजन की तारीख और सेवानिवृत्ति का चयन करें<span style="color: red">*</span>
                                        </label>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input id="NotesheetOrderNo." placeholder="Enter Notesheet Order No." type="number" class="form-control" />
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3 mt-3">
                                    <div class="form-group">
                                        <label>
                                            Select Notesheet Order Upload / 
                                        <br />
                                            नोटशीट आदेश अपलोड करें<span style="color: red">*</span>
                                        </label>
                                ...
                                <table class="table text-center">
                                    <thead>
                                        <tr style="white-space: nowrap;">
                                            ...
                                            <th>Last Posting OIS(Code)/<br />
                                                अंतिम पोस्टिंग ओआईएस(कोड)</th>

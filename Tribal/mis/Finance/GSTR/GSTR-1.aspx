            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="=page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"> <a href="#GSTR" data-bs-toggle="collapse" onclick="SidebarToggle('Finance')" role="button" aria-expanded="false"><span>GSTR</span></a></li>
                    <li class="breadcrumb-item active"><a title="click to go on"> GSTR-1</a></li>
                    </ol>
                </div>
            </div>
        </div>
   ...
   <br />
                    ...
                    <fieldset id="FS_Details" style="display: none">
                        ...
                        <div class="custom-div mt-0 mb-0" id="gstrsummary">
                            <div class="row align-items-end">
                                <div class="col-md-6">
                                    <h5><b>GSTIN/UIN: 23AACCMO330Q1ZM</b></h5>
                                </div> 
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="" id="Table">
                                                    ...
                                                    <tbody>
                                                        <tr role="row">
                                                            <td>1</td>
                                                            <td style="color:cornflowerblue;">B2B Invoices - 4A, 4B, 4C, 6B, 6C</td>
                                                            <td>1</td>
                                                            <td>771144.00</td>
                                                            <td>0.00</td>
                                                            <td>6940.26</td>
                                                        ...
                                                        <tr role="row" >
                                                            <td>2</td>
                                                            <td style="color:cornflowerblue;">B2C(Large) Invoices - 5A, 5B</td>
                                                            <td>0</td>
                                                            <td>0.00</td>
                                                            <td></td>
                                                            <td></td>
                                                        ...
                                                        <tr role="row">
                                                            <td>3</td>
                                                            <td style="color:cornflowerblue;">B2C(small) Invoices -7</td>
                                                            <td>0</td>
                                                            <td>0.00</td>
                                                            <td></td>
                                                            <td></td>
                                                        ...
                                                        <tr role="row" >
                                                            <td>4</td>
                                                            <td style="color:cornflowerblue;">Credit/Debit Notes(Registered) - 9B</td>
                                                            <td>0</td>
                                                            <td>0.00</td>
                                                            <td></td>
                                                            <td></td>
                                                         ...
                                                         <tr role="row" >
                                                            <td>5</td>
                                                            <td style="color:cornflowerblue;">Credit/Debit Notes(Unregistered) - 9B</td>
                                                            <td>0</td>
                                                            <td>0.00</td>
                                                            <td></td>
                                                            <td></td>
                                                        ...
                                                        <tr role="row" >
                                                            <td>6</td>
                                                            <td style="color:cornflowerblue;">Export Invoices - 6A</td>
                                                            <td></td>
                                                            <td></td>
                                                            <td></td>
                                                            <td></td>
                                                        ...
                                                        <tr role="row" >
                                                            <td>7</td>
                                                            <td style="color:cornflowerblue;">Tax Liability(Advances received)-11A(1), 11A(2)</td>
                                                            <td></td>
                                                            <td></td>
                                                            <td></td>
                                                            <td></td>
                                                        ...
                                                        <tr role="row" >
                                                            <td>8</td>
                                                            <td style="color:cornflowerblue;">Adjustment of Advances - 11B(1),11B(2) </td>
                                                            <td></td>
                                                            <td></td>
                                                            <td></td>
                                                            <td></td>
                                                        ...
                                                        <tr role="row" >
                                                            <td>5</td>
                                                            <td style="color:cornflowerblue;">Nil Rated Invoices - 8A, 8B, 8C, 8D</td>
                                                            <td>0</td>
                                                            <td>0.00</td>
                                                            <td></td>
                                                            <td></td>

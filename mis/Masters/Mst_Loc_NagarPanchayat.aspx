...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="=page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><span>Nagar Panchayat Master Data</span></li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="marqueecontainer">
        ...
        <div>
            <marquee style="width: 100%;" onmouseover="this.stop();" onmouseout="this.start();" direction="left" behavior="scroll" scrollamount="7" class="Marqueetext">
                इस पेज के माध्यम से नए नगर पंचायत को  Registered किया जाता है, यदि किसी कारणवश त्रुटी हो जाती हैं तो Registration Edit or Isactive भी किया जा सकता हैं |
            </marquee>
        </div>
    </div>
    <div class="card card-border-primary">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="card-title">Nagar Panchayat Master / नगर पंचायत मास्टर</h4>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <fieldset>
                <legend>Add Nagar Panchayat / नगर पंचायत जोड़े</legend>
                <div class="row align-items-end">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <label>
                                Enter Nagar Panchayat Name (In English)<br />
                                नगर पंचायत का नाम दर्ज करे(अंग्रेजी में)<span style="color: red">*</span></label>
                            <input name="ctl00$ContentBody$ctl04" type="text" class="form-control" autocomplete="off" placeholder="Enter Nagar Panchayat Name" />
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <label>
                                Enter Nagar Panchayat Name (In Hindi)<br />
                                नगर पंचायत का नाम दर्ज करे(हिंदी में)<span style="color: red">*</span></label>
                            <input name="ctl00$ContentBody$ctl05" type="text" class="form-control" autocomplete="off" placeholder="पंचायत का नाम दर्ज करे" />
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <label>
                                Enter Nagar Panchayat Code No.<br />
                                नगर पंचायत कोड संख्या दर्ज करे<span style="color: red">*</span></label>
            ...
            <fieldset>
                <legend>Nagar Panchayat Details / नगर पंचायत विवरण</legend>
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tr>
                                    ...
                                    <th>Block Name
                                        <br />
                                        विकासखण्ड का नाम </th>
                                    <th>Nagar Panchayat Name (In English)<br />
                                        नगर पंचायत का नाम (अंग्रेज़ी में)</th>
                                    <th>Nagar Panchayat Name (In Hindi)<br />
                                        नगर पंचायत का नाम (हिंदी में)</th>
                                    <th>Nagar Panchayat Code No.
                                        <br />

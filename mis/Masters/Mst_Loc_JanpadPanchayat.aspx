            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="=page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><span>Janpad Panchayat Master Data</span></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <fieldset>
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <label>Enter Janpad Panchayat Name (In English)<br />
                                जनपद पंचायत का नाम दर्ज करे(अंग्रेजी में)<span style="color: red">*</span></label>
                            <input name="ctl00$ContentBody$ctl04" type="text" class="form-control" autocomplete="off" placeholder="Enter Janpad Panchayat Name" />
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <label>Enter Janpad Panchayat Name (In Hindi)<br />
                                जनपद पंचायत का नाम दर्ज करे(हिंदी में)<span style="color: red">*</span></label>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <label>
                                Enter Janpad Panchayat Code No.<br />
                                जनपद पंचायत कोड संख्या दर्ज करे<span style="color: red">*</span></label>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            ...
                            <label class="form-check-label">
                                Status
								<small>Status(Active/InActive)</small><br>
                                ...
                                <thead class="nowrap">
                                    <tr>
                                        ...
                                        <th>Block Name
                                            <br />
                                            विकासखण्ड का नाम</th>
                                        <th>Janpad Panchayat Name (In English)<br />
                                            जनपद पंचायत का नाम (अंग्रेजी में)</th>
                                        <th>Janpad Panchayat Name (In Hindi)<br />
                                            जनपद पंचायत का नाम (हिंदी में)</th>
                                        <th>Janpad Panchayat Code No.
                                            <br />

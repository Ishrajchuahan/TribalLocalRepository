...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    ...
    <div class="card card-border-primary">
            ...
            <div class="row align-items-end">
                <div class="col-lg-12">
                    <h4>Reviewing Officer/
                     Acceptanceing Officer Report Print
                    </h4>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <fieldset id="show2">
                <legend>Reviewing and
                     Acceptanceing Officer Report Print Application / समीक्षा और
                     स्वीकारकर्ता अधिकारी रिपोर्ट प्रिंट आवेदन</legend>
...
वित्तीय वर्ष</th>
                                        ...
                                        <th>Reporting Officer Report<br />
                                            रिपोर्टिंग अधिकारी की रिपोर्ट</th>
                                        <th>Accepting Authority Report<br />
                                            स्वीकृति प्राधिकारी की रिपोर्ट</th>
                                ...
                                <tbody>
                                    <tr valign="middle">
                                        ...
                                        <td>
                                            <a role="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop1"><i class="fa fa-print" aria-hidden="true"></i></a>
                                        </td>
                                        <td>
                        ...
                        <div class="modal-body">
                            <fieldset>
                                ...
                                <div class="row text-center">
                                    <div class="col-sm-2">
                                        <img id="imgLogopP" src="../../img/image-260nw-1902805156.jpg" style="width: 140px; height: auto; background: none" class="responsive" />
                                    </div>
                                            ...
                                            <div class="">
                                                ...
                                                <table id="tblAcceptingAuthority" class="table table-bordered table-st fs-5">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>If no or agree partially give reasons for disagreement<br />
                                                            यदि नही या आंशिक रूप से सहमत होने पर बसहमति का कारण </th>
                                                        <td>Nil</td>
                                                    </tr>
                                                    <tr class="mt-3">
                                                        <th>Grading<br />
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <table id="tblEmploeeDtl" class="table table-bordered  modal-table">
                                                <tr>
                                                    <th>S.No.<br />
                                                        सरल क्र.</th>
                                                ...
                                                <tr>
                                                    <td class="fw-medium">(a) Use of teaching learning aid
                                        <br />
                                                ...
                                                <tr>
                                                    <td class="fw-medium">(b)Use of lesson plan<br />
                                                ...
                                                <tr>
                                                    <td class="fw-medium">(c)Innovation and Impact<br />
                                                ...
                                                <tr>
                                                    <td class="fw-medium">(d)checking  of notebook of student<br />
                                                ...
                                                <tr>
                                                    <td class="fw-medium">(e)Remendial teaching<br />
                                                ...
                                                <tr>
                                                    <td class="fw-medium">(f)Extra classes<br />
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center mb-5 fw-medium" rowspan="4" style="vertical-align: middle;">15</td>
                                                    <td colspan="2"></td>
                                                </tr>
                                                <tr>
                                                    <td class="fw-medium">(a)Sports/Literacy/Cultural Activities<br />
                                                        खेल/साहित्यिक/सास्कृतिक गतिविधियाँ</td>
                                                    <td class="text-center fw-medium">
                                                    5<td class="fw-medium">hardworking student</td>
                                                </tr>
                                                <tr>
                                                    <td class="fw-medium">(b)Extra ordinary workin Hygiene/Environment<br />
                                                        स्वच्छता/पर्यावरण के क्षेत्र में किया गया कार्य</td>
                                                    <td class="text-center fw-medium">
                                                    5<td class="fw-medium">hardworking student</td>
                                                </tr>
                                                <tr>
                                                    <td class="fw-medium">(c)Use of ICT in teaching and learning<br />
                                                ...
                                                <tr>
                                                    <td class="fw-medium">(a)Attitude of work and sense of responsibility<br />
                                                ...
                                                <tr>
                                                    <td class="fw-medium">(b)Maintenance of discipline<br />
                                                        अनुशासन</td>
                                                    <td class="text-center fw-medium">3</td>
                                                    <td class="fw-medium">hardworking student </td>
                                                ...
                                                <tr>
                                                    <td class="fw-medium">(c)Communication skill<br />
                                                        संप्रेषण कौशल</td>
                                                ...
                                                <tr>
                                                    <td class="fw-medium">(d)Capacity to work in a team with team spirit and inter Personal
relations<br />

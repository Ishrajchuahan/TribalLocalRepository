<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Trn_JDCompassionateApproval.aspx.cs" Inherits="mis_HRMS_Trn_JDCompassionateApproval" %>
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                    ...
                    <div class="=page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item">Register Application For Compassionate Appointment on JD Level</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <div class="card card-border-primary">
        ...
        <div class="card-body">
            ...
            <br />
                        ...
                        <br />आवेदक का जन्म तिथि का प्रमाण पत्र :<span style="color: red">*</span></label>
                                    </div>

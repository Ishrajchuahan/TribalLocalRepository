    ...
    <div class="card card-border-primary">
        ...
        <div class="card-body">
            <div class="row form-group m-2">
                <div class="col-md-3">
                    <label class="font-bold text-dark">OIS Type /<br />
            ...
            <fieldset>
                ...
                <div class="row form-group">
                    <div class="col-md-3 mt-3">
                        <label class="font-bold">Division Name/<br />
                    ...
                    <div class="col-md-3 mt-3">
                        <label class="font-bold">Block Name<br />
                    ...
                    <div class="col-md-3 mt-3">
                        <div class="form-group">
                            <label class="font-bold">Institute Type/<br />
                                संस्थान का प्रकार</label>

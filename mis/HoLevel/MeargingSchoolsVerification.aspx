<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="MeargingSchoolsVerification.aspx.cs" Inherits="mis_HoLevel_MeargingSchoolsVerification" %>
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-12">
                        <div class="form-group ">
                            ...
                            <a href="MeargingSchoolsVerification.aspx" class="btn w-lg btn-outline-danger btn-border">Clear</a>
                        </div>
                    </div>
                </div>
            </fieldset>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered table-responsive " style="border: 2px">
                            ...
                            <thead class="nowrap">
                                <tr>
                                    <th colspan="9">School to merge
                                        <br />
                                        स्कूल जिसका विलय करना हैं|</th>

                                    <th colspan="6">Anchor School to be Merged
                                        <br />
                                        स्कूल जिसमे विलय करना हैं|</th>
...
23445656546</asp:HyperLink>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:LinkButton ID="LinkButton3" runat="server" CssClass="btn view-but" data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg2" OnClientClick="return false;"><i class="fas fa-eye"></i></asp:LinkButton>
                                    </td>
                                    <td scope="col">
                                        <input type="checkbox" /></td>
                                    <td>07/12/2023</td>
...
23450404152</asp:HyperLink>
                ...
                <div class="" runat="server" id="divbutton" visible="false">
                    <hr />
                    <div class="col-md-12">
                        <div class="form-group">
 ...
 Additionally, by clicking on the 'Documents' Button, they can also view request, related documents .
                                ...
                                <li><strong>Merge School</strong>
                                    <ul>
                                        <li>It is mandatory to click on the checkbox in front of the data to <strong>Merge</strong> the relevant School.
                                                  After that the School will be Merged .</li>
                                    </ul>
                                </li>
            ...
            <div class="modal" tabindex="-1" role="dialog" id="OTPModal">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer justify-content-center">
                            <button type="button" class="btn w-lg btn-outline-success Alert-Mergeschool" data-bs-dismiss="modal">Submit</button>
                            <button type="button" class="btn btn-outline-danger w-lg btn-border" data-bs-dismiss="modal">Close</button>
                        </div>
                    </div>
                </div>
    ...
    <script>
        !function ($) {
            ...
            SweetAlert.prototype.init = function () {
                ...
                $('.Alert-Mergeschool').click(function () {
                    Swal.fire({
                        title: 'Are you sure?',
                        ...
                        if (result.value) {
                            Swal.fire({
                                type: 'success',
                                title: 'Success!',
                                text: 'School Merged Successfully!',
                                timer: 2000
                                // animation: false,
                                // customClass: {
                                //     popup: 'animated tada'

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="SankulWiseSummaryOfProgressOfReviewAndVerificationofSchoolDirectory - Copy.aspx.cs" Inherits="mis_Transaction_SankulWiseSummaryOfProgressOfReviewAndVerificationofSchoolDirectory" %>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4 text-center mt-4">
                        <div class="form-group">
                            <asp:Button runat="server" class="btn btn-success shadow" Text="Get Sankul-Wise Summary" OnClick="Unnamed_Click" />
                        </div>
                    </div>
                </div>
            </fieldset>

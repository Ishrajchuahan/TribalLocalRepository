<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_ESICReport.aspx.cs" Inherits="mis_Payroll_Rpt_ESICReport" %>
        ...
        <div class="container-fluid">
            <div class="row page-titles mb-4">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor ">ESIC Report</h4>
                </div>
                <div class="col-md-7 align-self-center text-end">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">ESIC Report</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                    ...
                    <div class="=page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><span>ESIC Report</span></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="card card-border-primary">
            <div class="card-header">
                <div class="row align-items-end">
                    <div class="col-lg-12">
                        <h5 class="card-title">ESIC Report/


ई.एस.आई.सी रिपोर्ट</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <fieldset>
                    <legend>ESIC Report/ESIC Report/


ई.एस.आई.सी रिपोर्ट</legend>
                    <div class="row">
                        <div class="col-md-3">
                    ...
                    <%--    <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <a href="Rpt_ESICReport.aspx" class=" btn-block btn btn-danger  btn-rounded">Clear</a>
                                </div>
                            </div>
                          </div> --%>
                    <hr />
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <a href="Rpt_ESICReport.aspx" class=" btn btn-outline-danger w-lg btn-rounded">Clear</a>
                        </div>
                    </div>
                </fieldset>
                <fieldset id="show">
                    <legend>ESIC (Report)/ई.एस.आई.सी. (रिपोर्ट)</legend>
                            ...
                            <table class="table">
                                <tr>
                                    ...
                                    <th>Gross wages<br />
                                        कुल वेतन</th>
                                    <th>ESIC PERCENT(%)<br />
                                        ई.एस.आई.सी. प्रतिशत(%)</th>
                                    <th>ESIC DEDUCTION<br />
                                        ई.एस.आई.सी कटौती</th>
                                    <th>DEPOSIT DATE<br />
                                        जमा तिथि</th>
                                    <th>CHALLAN NO.<br />

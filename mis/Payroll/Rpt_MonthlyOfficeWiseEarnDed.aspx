<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_MonthlyOfficeWiseEarnDed.aspx.cs" Inherits="mis_Payroll_Rpt_MonthlyOfficeWiseEarnDed" %>
        ...
        <%--   <div class="container-fluid">
            <div class="row page-titles mb-4">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor ">Monthly Office Wise Single Head Report</h4>
                </div>
                <div class="col-md-7 align-self-center text-end">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Monthly Office Wise Single Head Report</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                    ...
                    <div class="=page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><span>Monthly Office Wise Single Head Report</span></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="card card-border-primary">
            <div class="card-header">
                <div class="row align-items-end">
                    <div class="col-lg-12">
                        <h5 class="card-title">Monthly Office Wise Single Head Report/

मासिक कार्यालयवार एकल प्रमुख रिपोर्ट</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <fieldset>
                    <legend>Monthly Office Wise Single Head Report/मासिक कार्यालयवार एकल प्रमुख रिपोर्ट</legend>
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Earning & Deduction Head<br />
                                    कमाई एवं कटौती शीर्ष<span style="color: red;">*</span></label>
                                <select class="form-control select2">
                                    <option value="0">Select</option>
                    ...
                    <%--   <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <a href="Rpt_MonthlyOfficeWiseEarnDed.aspx" class=" btn-block btn btn-danger  btn-rounded">Clear</a>
                                </div>
                            </div>
                        </div>--%>
                    <hr />
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <a href="Rpt_MonthlyOfficeWiseEarnDed.aspx" class=" btn btn-outline-danger w-lg btn-rounded">Clear</a>
                        </div>
                    </div>
                </fieldset>
                <fieldset id="show">
                    ...
                    <div class="row">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    <td>3</td>
                                    <td>Hoshangabad- Circle Office</td>
                                    <td>0.00</td>
                                    <td>3</td>
                                </tr>
                            </table>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="DisposeApplicatonCaseForJD.aspx.cs" Inherits="mis_Transaction_DisposeApplicatonCaseForJD" %>
           ...
           <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
               ...
               <div class="=page-title-right">
                   <ol class="breadcrumb m-0">
                       ...
                       <li class="breadcrumb-item"><span>Compassionate Appointment Print Application JD</span></li>
                   </ol>
               </div>
           </div>
       </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="GanaveshSHGReportDistrictWise.aspx.cs" Inherits="mis_Scheme_GanaveshSHGReportDistrictWise" %>
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="=page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">District Wise Uniform Demand & Distribution Progress</li>
                    </ol>
                </div>
            </div>
        </div>

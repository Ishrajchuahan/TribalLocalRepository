<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="ViewEnrolled.aspx.cs" Inherits="mis_Scheme_ViewEnrolled" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">View enrolled students in the class</h4>
            </div>
  ...
  <li class="breadcrumb-item"><a href="../Module.aspx?ID=SchemeManagement" title="click to go on">Scheme Management</a></li>
                        <li class="breadcrumb-item active">View Enrolled List</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="card mt-3 shadow" id="divStudentDetail" style="display: none;">
        ...
        <div class="card-body">
            <fieldset>
                <legend>View enrolled students in the class</legend>

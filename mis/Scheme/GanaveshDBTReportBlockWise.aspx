            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="=page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">Block Wise Uniform Distribution Report</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="card card-border-primary">
        <div class="card-header">
            <div class="row align-items-end">
                <div class="col-lg-9">
                    <h4 class="card-title">Block Wise Uniform Distribution Report /
        ब्लॉक वार यूनिफार्म वितरण रिपोर्ट</h4>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="mt-3">
                <fieldset>
                    <legend>Block Wise Uniform Distribution Report / ब्लॉक वार यूनिफार्म वितरण रिपोर्ट</legend>
                    <div class="row align-items-end">
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <a href="GanaveshDBTReportBlockWise.aspx" class="btn btn-outline-danger w-lg btn-border">Clear</a>
                            </div>
                        </div>
                    </div>
                </fieldset>

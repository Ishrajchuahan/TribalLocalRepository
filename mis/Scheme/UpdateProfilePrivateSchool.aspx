<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="UpdateProfilePrivateSchool.aspx.cs" Inherits="mis_Scheme_UpdateProfilePrivateSchool" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    <div class="row page-titles mb-4">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor ">Update Profile for Private School
        ...
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="ChangePassword.aspx" title="click to go on">Update Profile for Private School</a></li>
        ...
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                ...
                <div class="mt-5">
                    <fieldset>
                        <legend>Update Profile for Private School</legend>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <select class="form-control">
                                            ...
                                            <option value="PrivateEmployee">PrivateSchool</option>

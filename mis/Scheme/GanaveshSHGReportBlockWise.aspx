<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="GanaveshSHGReportBlockWise.aspx.cs" Inherits="mis_Scheme_GanaveshSHGReportBlocklWise" %>
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="=page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">Block Wise Uniform Demand & Distribution Progress</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="card card-border-primary">
        <div class="card-header">
            <div class="row align-items-end">
                <div class="col-lg-9">
                    <h4 class="card-title">Block Wise Uniform Demand & Distribution Progress
                        <br />
                       ब्लॉकवार यूनिफार्म मांग एवं वितरण प्रगति</h4>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="mt-3">
                <fieldset>
                    <legend>Block Wise Uniform Demand / ब्लॉक-वार यूनिफार्म की मांग  </legend>
                    <div class="row align-items-end">
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <button type="button" id="btnShowStudentDetails" class="btn btn-success btn-border w-lg" onclick="Show();">ब्लॉक-वार यूनिफार्म की मांग देखे</button>
                                <a href="GanaveshSHGReportBlockWise.aspx" class="btn btn-outline-danger w-lg btn-border">Clear</a>
                            </div>
                        </div>
                    </div>
                </fieldset>
                            ...
                            <div class="table-responsive">
                                <table class="table text-center table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td>
                                            <div style='text-align: center; color: Maroon;'>Total</div>
                                        </td>
                                        <td>
                                            <div style='text-align: left; color: Maroon;'>571</div>
                                        </td>
                                        <td>
                                            <div style='text-align: left; color: Maroon;'>502</div>
                                        </td>
                                        <td>
                                            <div style='text-align: left; color: Maroon;'>1142</div>
                                        </td>
                                        <td>
                                            <div style='text-align: left; color: Maroon;'>1004</div>
                                        </td>
                                        <td>
                                            <div style='text-align: left; color: Maroon;'>1154</div>
                                        </td>
                                        <td>
                                            <div style='text-align: left; color: Maroon;'>992</div>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    </tr>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_ProjectApproval.aspx.cs" Inherits="mis_Development_Rpt_ProjectApproval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    ...
    <div class="card card-border-primary">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-7">
                    <h4 class="card-title">Project Approval Report / 
                        परियोजना स्वीकृति रिपोर्ट</h4>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <fieldset>
                <legend>Project Approval Report/ परियोजना स्वीकृति रिपोर्ट</legend>
            ...
            <fieldset>
                <legend>Project Approval Deatils / परियोजना स्वीकृति विवरण</legend>
